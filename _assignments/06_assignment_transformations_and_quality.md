...
### Deliverables
This assignment is more technical than the previous ones. Please think closely about and provide some examples for data transformations you're planning to conduct. You needn't have everything figured out yet, but you'll probably want to actually start working with your sample data at this point. Post a link to your description of how you will accept data, ensure its quality and provenance, and transform it as part of your curation project [to the canvas board](https://canvas.uw.edu/courses/1724350/discussion_topics/8917519).